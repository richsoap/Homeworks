...
sns.lineplot(x='Eb/N0', y='EBR', hue="type", style="type", data=data, markers=['x'], ax=axes[0])
sns.lineplot(x='Eb/N0', y='EFR', hue="type", style="type", data=data, markers=['x'], ax=axes[1])
plt.show()